  ...
  const services = [
    {
      ...
      icon: Icon.education,
      title: "Edukáció",
      desc: "Videós kurzusok a vállalkozásról, pénzügyekről, marketingről és az AI-ról.",
    ...
    },
    {
      ...
      desc: "Gyakorlati digitális készségek: dokumentumok, táblázatok, prezentációk.",
      stat: "Fejlesztés alatt – előzetes tartalom",
      progress: 0,
